      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            I am a full stack web developer and experience health data analyst with a passion for creating
            interactive and responsive web applications. I have experience
            working with JavaScript, React, php, Node.js, Express, PostgreSQL,
            MySql,mongoDb,RESTful API's, HTML, CSS, and Git. I am a quick learner and I am always
